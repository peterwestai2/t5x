...
def build_task(input_files, task_name, mask_fields=None, p_full=0.5, field_mask_options = None, metric_fns = [], tsv_fields=['premise','question','hypothesis','reasonable']):
    '''
    ...
    if mask_fields is None:
        mask_fields = ['premise','question','hypothesis','reasonable']
