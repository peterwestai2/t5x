...
# ==================================== may18 critic with both none and nonone ======================================
# 20k round2 human annotations, with both "none" and "nonone" formats
    
dataset_name = 'may18_critic_with_none_nonone'
file_template = 'gs://ai2-mosaic-public/projects/symbolic-knowledge-decoding/data/may18_critic_with_none_nonone/{}.tsv'
input_files = {'train':file_template.format('train'),
            'test':file_template.format('test'),
            'validation':file_template.format('val')}
mask_fields =  ['plausibility']
...
# ==================================== may18 nnone ======================================
# Uses the old dataset (no nones) + 20k human annotations (none and nonone)


annotation_task = 'may18_critic_with_none_nonone'

experiment_name = 'may18_none_human20k'
...
annotation_task = 'may18_critic_with_none_nonone'
experiment_name = 'may19_turbo_lr0_00005_bs256_human20k'
add_iterative_task(annotation_task, experiment_name)
...
input_files = {'train':file_template,
            ...
            'validation':file_template}
mask_fields =  ['plausibility']
build_task(input_files, dataset_name ,mask_fields, metric_fns =[metrics.bleu,metrics.rouge], tsv_fields=['aux','plausibility','d','inputs','context','plausibility_p','prediction','query','inference','label','index'])
...
dataset_name = 'june19_quark_quartile_qa'
file_template = 'gs://ai2-mosaic-public/projects/symbolic-knowledge-decoding/SKD-2023-data/june19_quartile_annotation/train_dataset_qa_{}.tsv'
input_files = {'train':file_template.format('train'),
            'test':file_template.format('test'),
            'validation':file_template.format('val')}
mask_fields = ['context','inference','plausibility']
...
dataset_name = 'june19_quark_quartile_v1'
file_template = 'gs://ai2-mosaic-public/projects/symbolic-knowledge-decoding/SKD-2023-data/june19_quartile_annotation/train_dataset_v1_{}.tsv'
input_files = {'train':file_template.format('train'),
            'test':file_template.format('test'),
            'validation':file_template.format('val')}
mask_fields = ['context','query','inference','plausibility']
...
## scoring the over generations
dataset_name = 'june20_generation_annotation'
file_template = 'gs://ai2-mosaic-private/peter-skd-2023/june20_generation/data_to_score.tsv'
input_files = {'train':file_template,
            'test':file_template,
            'validation':file_template}
mask_fields =  ['plausibility']
